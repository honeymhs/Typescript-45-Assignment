...
*/
let transport = ["Suzuki Motorcycle", "BMW Car", "Banaweer Bicycle"];
...
• Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order
 has changed.
*/
let places = ["Saudi Arabia", "United Kingdom", "Germany", "Switzerland", "Finand"];
...
*/
let Guest = ["Imran", "Sameer", "Bilal", "Ali", "Adda"];
...
these items.
*/
let Places = ["Mariana Trench", "Singapore", "London", "Niagra falls"];
